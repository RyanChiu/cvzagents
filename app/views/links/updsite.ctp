...
echo $form->create(null, array('controller' => 'links', 'action' => 'updsite'));
?>
<table style="width:100%">
	...
	<tr>
		...
		<div style="float:left">
		<?php
		echo $form->input('Site.payouts', array('label' => '', 'style' => 'width:390px;'));
		?>
		</div>
		<div style="float:left"><font color="red">*</font></div>
		</td>
...
<?php
echo $form->input('Site.id', array('type' => 'hidden'));
echo $form->end();
?>
